...
screen quick_menu():
    imagebutton auto "images/elements/fstmenu/fset_%s.png" focus_mask True xpos 1770 ypos 960 action ShowMenu('preferences')
    imagebutton auto "images/elements/fstmenu/fhist_%s.png" focus_mask True xpos 1773 ypos 860 action ShowMenu('history')
    imagebutton auto "images/elements/fstmenu/fnext_%s.png" focus_mask True xpos 1770 ypos 760 action Skip() alternate Skip(fast=True, confirm=True)
    imagebutton auto "images/elements/fstmenu/fback_%s.png" focus_mask True xpos 1645 ypos 959 action Rollback()
    imagebutton auto "images/elements/fstmenu/fsave_%s.png" focus_mask True xpos 1645 ypos 862 action ShowMenu('save')
    imagebutton auto "images/elements/fstmenu/fauto_%s.png" focus_mask True xpos 1645 ypos 758 action Preference("auto-forward", "toggle")
    ...
    if quick_menu:
        ...
        hbox:
            ...
            xalign 1.0
            yalign 0
            textbutton _("Авто воспроизведение включено") action Preference("auto-forward", "toggle")
...
screen main_menu():
    ...
    python:
        renpy.music.queue("theme.mp3", channel = "music", fadein = 1)

    tag menu

    style_prefix "main_menu"

    add "images/elements/mainfon.png"

    imagebutton auto "images/elements/help_%s.png" focus_mask True action Help()
    imagebutton auto "images/elements/play_%s.png" focus_mask True action Start()
    imagebutton auto "images/elements/exit_%s.png" focus_mask True action Quit(confirm = True)
    imagebutton auto "images/elements/option_%s.png" focus_mask True action ShowMenu("preferences")
    imagebutton auto "images/elements/load_%s.png" focus_mask True action ShowMenu("load")
...
screen game_menu(title, scroll=None, yinitial=0.0):
    ...
    add "images/elements/aboutfon.png"
    ...
    imagebutton auto "images/elements/back_%s.png" focus_mask True action Return()
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    bar idle_left_bar "images/elements/pref/bar_u_full_idle.png" hover_left_bar "images/elements/pref/bar_u_full_idle.png" idle_right_bar "images/elements/pref/bar_u_empty_idle.png" hover_right_bar "images/elements/pref/bar_u_empty_idle.png" idle_thumb "images/elements/pref/thumb_u_idle.png" hover_thumb "images/elements/pref/thumb_u_idle.png" thumb_shadow None value Preference("text speed")

                    label _("Скорость авточтения")

                    bar idle_left_bar "images/elements/pref/bar_u_full_idle.png" hover_left_bar "images/elements/pref/bar_u_full_idle.png" idle_right_bar "images/elements/pref/bar_u_empty_idle.png" hover_right_bar "images/elements/pref/bar_u_empty_idle.png" idle_thumb "images/elements/pref/thumb_u_idle.png" hover_thumb "images/elements/pref/thumb_u_idle.png" thumb_shadow None value Preference("auto-forward time")
                ...
                vbox:
                    ...
                    if config.has_music:
                        ...
                        hbox:
                            bar idle_left_bar "images/elements/pref/bar2_u_full_idle.png" hover_left_bar "images/elements/pref/bar2_u_full_idle.png" idle_right_bar "images/elements/pref/bar2_u_empty_idle.png" hover_right_bar "images/elements/pref/bar2_u_empty_idle.png" idle_thumb "images/elements/pref/thumb_u_idle.png" hover_thumb "images/elements/pref/thumb_u_idle.png" thumb_shadow None value Preference("music volume")
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            bar idle_left_bar "images/elements/pref/bar2_u_full_idle.png" hover_left_bar "images/elements/pref/bar2_u_full_idle.png" idle_right_bar "images/elements/pref/bar2_u_empty_idle.png" hover_right_bar "images/elements/pref/bar2_u_empty_idle.png" idle_thumb "images/elements/pref/thumb_u_idle.png" hover_thumb "images/elements/pref/thumb_u_idle.png" thumb_shadow None value Preference("sound volume")
                    ...
                    if config.has_voice:
                        ...
                        hbox:
                            bar idle_left_bar "images/elements/pref/bar2_u_full_idle.png" hover_left_bar "images/elements/pref/bar2_u_full_idle.png" idle_right_bar "images/elements/pref/bar2_u_empty_idle.png" hover_right_bar "images/elements/pref/bar2_u_empty_idle.png" idle_thumb "images/elements/pref/thumb_u_idle.png" hover_thumb "images/elements/pref/thumb_u_idle.png" thumb_shadow None value Preference("voice volume")
